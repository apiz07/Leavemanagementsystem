...
$username=$_SESSION['emplogin'];
    $sql ="SELECT Password FROM employeeleave WHERE EmailId=:username and Password_emp=:password";
...
if($query -> rowCount() > 0)
{
$con="update employeeleave set Password_emp=:newpassword where EmailId=:username";
