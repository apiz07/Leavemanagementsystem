...
$con="update employeeleave set Password_emp=:newpassword where id=:empid";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>FKI BROTHA | Password Recovery</title>
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">FKI BROTHA | Employee Leave Management System</span>
                        </div>
...
$empid=$_POST['empid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM employeeleave WHERE EmailId=:email and EmpId=:empid";
