<aside id="slide-out" class="side-nav white fixed">
                <div class="side-nav-wrapper">
                    ...
                    <?php
$eid=$_SESSION['eid'];
$sql = "SELECT F_name, L_name, EmpId from employeeleave where id=:eid";
...
{               ?>
                                <p><?php echo htmlentities($result->F_name." ".$result->L_name);?></p>
  ...
  <li class="no-padding"><a class="waves-effect waves-grey" href="emp-changepassword.php"><i class="material-icons">settings_input_svideo</i>Change Password</a></li>
                ...
                <div class="footer">
                    <p class="copyright">Brought to You By &copy FKI BROTHA <?php echo date('Y'); ?></p>
