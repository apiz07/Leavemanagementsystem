...
if(isset($_POST['signin']))
{
    ...
    $sql ="SELECT EmailId, Password_emp, Status,id FROM employeeleave WHERE EmailId=:uname and Password_emp=:password";
...
<head>
        ...
        <!-- Title -->
        <title>FKI BROTHA | Home Page</title>
...
<body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">
                            <span class="chapter-title">FKI BROTHA | Leave Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright">&copy FKI BROTHA <?php echo date('Y'); ?> </p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to FKI BROTHA Leave Management System</h4></div>
