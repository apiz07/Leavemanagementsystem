...
$username=$_SESSION['alogin'];
    $sql ="SELECT passwords FROM adminleave WHERE username=:username and passwords=:password";
...
if($query -> rowCount() > 0)
{
$con="update adminleave set passwords=:newpassword where username=:username";
