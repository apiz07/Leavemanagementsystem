...
$sql="update employeeleave set F_name=:fname, L_name=:lname, Gender=:gender, dateob=:dob, Department=:department, Address=:address, City=:city, Country=:country, Phonenumber=:mobileno where id=:eid";
...
<?php 
$eid=intval($_GET['empid']);
$sql = "SELECT * from employeeleave where id=:eid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':eid',$eid, PDO::PARAM_STR);
$query->execute();
