...
$sql="update leavedept set DepartmentName=:deptname, DepartmentCode=:deptcode, DepartmentShortName=:deptshortname where id=:did";
...
<?php 
$did=intval($_GET['deptid']);
$sql = "SELECT * from leavedept WHERE id=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
