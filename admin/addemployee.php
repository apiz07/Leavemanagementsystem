...
$sql="INSERT INTO employeeleave(EmpId, F_name, L_name, EmailId, Password_emp, Gender, dateob, Department, Address, City, Country, Phonenumber, Status) VALUES (:empid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
