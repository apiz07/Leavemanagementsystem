...
$sql = "SELECT leaves.id as lid, employeeleave.F_name, employeeleave.L_name, employeeleave.EmpId, employeeleave.id, employeeleave.Gender, employeeleave.Phonenumber, employeeleave.EmailId, leaves.LeaveType, leaves.ToDate, leaves.FromDate, leaves.Description, leaves.PostingDate, leaves.Status, leaves.AdminRemark, leaves.AdminRemarkDate from leaves join employeeleave on leaves.empid=employeeleave.id where leaves.id=:lid";
$query = $dbh -> prepare($sql);
                                        ...
                                        <tr>
                                            <td style="font-size:16px;"> <b>Employee Name :</b></td>
                                              <td><a href="editemployee.php?empid=<?php echo htmlentities($result->id);?>" target="_blank">
                                                <?php echo htmlentities($result->F_name." ".$result->L_name);?></a></td>
